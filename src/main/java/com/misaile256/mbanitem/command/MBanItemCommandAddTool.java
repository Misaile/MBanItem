...
public class MBanItemCommandAddTool extends MBanItemCommand {

	protected MBanItemCommandAddTool() {
		super("addtool");
	}
	...
	public boolean execute(Player player, String[] args) {
		...
		try {
			...
			MBanUtil.Message.infoItem(itemStack, player, ItemType.TOOL, action, reason);
			if (MBanItem.getInstance().getBlackItemConfig().addBanItem(itemStack, ItemType.TOOL, action, reason)) {
