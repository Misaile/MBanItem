...
public class MBanItemCommandAdd extends MBanItemCommand {

	protected MBanItemCommandAdd() {
		super("add");
	}
	...
	public boolean execute(Player player, String[] args) {
		...
		try {
			...
			MBanUtil.Message.infoItem(itemStack, player, ItemType.NORMAL, action, reason);
			if (MBanItem.getInstance().getBlackItemConfig().addBanItem(itemStack, ItemType.NORMAL, action, reason)) {
